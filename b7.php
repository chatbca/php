...
htmlspecialchars($_SERVER["PHP_SELF"]); ?>"> 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") { 
        ...
        $sql = "INSERT INTO BOOK (book_number, book_title, price, quantity, 
discount_rate, discount_amount, net_bill_amount) VALUES ('$book_number', 
'$book_title', '$price', '$quantity', '$discount_rate', '$discount_amount', 
'$net_bill_amount')"; 
...
Title</th><th>Price</th><th>Quantity</th><th>Discount Rate 
(%)</th><th>Discount Amount</th><th>Net Bill Amount</th></tr>"; 
        echo "<tr>"; 
